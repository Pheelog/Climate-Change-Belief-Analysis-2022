...
st.markdown('''<div class='sub-body'> 
                <p class="sub-par">
                    ...
                    They would like to determine how people perceive climate change and whether or
                ...
                <p class="sub-par">
                    With this context, this notebook provides a walthrough the creation of a Machine Learning model
...
st.markdown('''<div class='sub-body'> 
                <p class="sub-par">
                    The fashion industry has a fdestructive effect on the climate. By estimation, the fashion industry accounts for 
                    about 8% of the total CO<sub>2</sub> global emission - greater than all the international flights, maritime and shipping 
                    combined. This is because people want to change clothes as quickly as possible and there is a need to match the growing
                    demands of glothes.
                </p>
            </div>''', unsafe_allow_html=True)
...
st.markdown('''<div class='sub-body'> 
                ...
                <p class="sub-par">
                    Petit Pli needs tomarket this product to a suitable market. Hence they need a market where there is a sentiment which 
