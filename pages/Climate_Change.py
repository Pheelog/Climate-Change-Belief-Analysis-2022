...
st.markdown('''<div class='sub-body'> 
                <p class="sub-par">
                    There are more tweets in support of the believe of man made Climate Change. 
...
st.markdown('''<div class='sub-body'> 
                <p class="sub-par">
                    ...
                    Hashtags gives an insight into such events. Before the flood is a popular hashtags used in pro climate change tweets, 
...
st.markdown('''<div class='sub-body'> 
                <p class="sub-par">
                    ...
                    have been on the fore-front of the movement. A look the handles in each tweet.
                </p>
            </div>''', unsafe_allow_html=True)
st.image('resources/imgs/hashtags.jpg')
...
st.markdown('''<div class='sub-body'> 
                <p class="sub-par">
                    Retweets is often used to repost a tweet. Most times people retweet posts which they agree with. In some instances
                    though, people can retweet a tweet with a quote showing thier reservations. The sentiment for man-made climate change 
                    has about twice more retweet than other sentiments.
                </p>
            </div>''', unsafe_allow_html=True)
